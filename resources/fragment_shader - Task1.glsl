...
#define RENDER_DEPTH 800       // much larger as if ray near paralell with cube surface,
                               // the sdf is very low so can only take very small steps and may never actually reach the cube
                               // so we increase the number of steps
